<template>
    <div class="about">
        ...
        <div class="container">
            ...
            <p>
                Obviously we have plans beyond the next few months - we will publish our roadmap in the future, for a more detailed overview of our long term goals! 
            </p>
